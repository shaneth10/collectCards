var Scratch = (function() {
    ...
    var Scratch = function(options) {
        ...
        this.defaults = {
            ...
            sceneWidth: 0, // Canvas width
            sceneHeight: 0, // Canvas height
            radius: 40, // Radius of scratch zone
            nPoints: 100, // n points for clear canvas
    ...
    Scratch.prototype.init = function() {
        ...
        this.image.src = this.options.pictureOver + '?v=' + Math.random()
        ...
        this.setBackground(this.options.imageBackground);
        this.setCursor();
    ...
    Scratch.prototype.setBackground = function(imageBackground) {
        var _this = this;
        this.image.onload = function() {
            _this.zone = _this.canvas.getBoundingClientRect();
            // Draw image
            _this.ctx.drawImage(this, 0, 0, canvasWidth, canvasHeight);
    ...
    Scratch.prototype.callback = function(callback) {
        if (callback != null && this.percent >= this.options.percent && !this.callbackRun) {
            callback();
